...
{
    internal abstract partial class BaseEventTracker<T> : GodotObject
    {
    ...
    {
        protected override Unit Cast(object o)
        {
            return new Unit();
        }
    }
    ...
    {
        protected override T Cast(object o)
        {
            return (T)o;
        }
    }
    ...
    internal partial class EventTracker<T1, T2, T3> : BaseEventTracker<(T1, T2, T3)>
    {
        ...
        {
            return ((T1, T2, T3))((object, object, object))o;
        }
    }
    ...
    internal partial class EventTracker<T1, T2, T3, T4> : BaseEventTracker<(T1, T2, T3, T4)>
    {
        ...
        {
            return ((T1, T2, T3, T4))((object, object, object, object))o;
        }
    }
    ...
    internal partial class EventTracker<T1, T2, T3, T4, T5> : BaseEventTracker<(T1, T2, T3, T4, T5)>
    {
        ...
        {
            return ((T1, T2, T3, T4, T5))((object, object, object, object, object))o;
        }
    }
    ...
    internal partial class EventTracker<T1, T2, T3, T4, T5, T6> : BaseEventTracker<(T1, T2, T3, T4, T5, T6)>
    {
        ...
        {
            return ((T1, T2, T3, T4, T5, T6))((object, object, object, object, object, object))o;
        }
    }
}